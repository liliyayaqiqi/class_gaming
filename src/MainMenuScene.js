...
export default class MainMenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.createCareerButton(centerX, 480, '👗 时装造型师', '设计时尚造型，引领潮流风向', 0xe91e63, 'FashionMenuScene')
    this.createCareerButton(centerX, 580, '🧋 奶茶大师', '调制美味饮品，创造甜蜜时光', 0xff9800, 'MilkTeaMenuScene')
  ...
  createCareerButton(x, y, title, description, color, targetScene) {
    ...
    // 判断是否已实现
    const isImplemented = targetScene === 'PoliceMenuScene' || targetScene === 'CarMenuScene' || targetScene === 'MilkTeaMenuScene' || targetScene === 'FashionMenuScene'
